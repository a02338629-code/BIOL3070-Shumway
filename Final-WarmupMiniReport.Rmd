...
Here is my abstract. I'm sure I say something about how significant this project is, what methods I use, and what the outcomes were. Yay.
...
The West Nile Virus (WNV) can be found in reservoirs of birds. Mosquitoes transmit the infection to humans and/or other animals as they take bloodmeals. Samples of mosquito bloodmeals taken from across the state can provide information on transmission cycle patterns that can be used to inform mosquito abatement efforts in the state. These samples can be amplified via PCR, sequenced, and compared to public datasets to map types of mosquito hosts where.
...
What bird species is acting as WNV amplifying hose in Salt Lake City?
